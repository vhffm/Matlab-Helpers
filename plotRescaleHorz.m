function plotRescaleHorz( scaleFactor, axs )
%
% Horizontally rescales the axis handle such that any xlabels that might
% have been been cut off are visible again.
%
